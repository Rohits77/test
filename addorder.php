...
if(isset($_POST['orderId'], $_POST['tableNum'], $_POST['phoneNum'], $_POST['dateTime'], $_POST['cart'])){
    ...
    $stmt = $conn->prepare("INSERT INTO orders (orderid, phonenum, tablenum, order_datetime) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $orderID, $phoneNum, $tableNum, $dateTime);
...
<body>
    ...
    <script>
        ...
        function goToHomePage() {
            window.location.href = "index.html"; // Replace 'home2.html' with the actual URL of your home page
        }
